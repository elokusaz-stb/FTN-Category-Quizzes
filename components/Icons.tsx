...
export const BasketIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
...
export const StarIcon: React.FC<{ className?: string; filled: boolean }> = ({ className = "w-5 h-5", filled }) => (
  <svg className={`${className} ${filled ? 'text-yellow-400' : 'text-gray-300'}`} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"></path></svg>
);
...
export const MinusIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 12H4"></path></svg>
);
...
export const LeafIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg
    ...
    strokeWidth="1.5"
  >
    <path d="M12,19 C12,14.5 12,10 12,5" strokeLinecap="round" />
    <path d="M12,12 C16,12 19,10 17,7" strokeLinecap="round" />
    <path d="M12,12 C8,12 5,10 7,7" strokeLinecap="round" />
  </svg>
);
